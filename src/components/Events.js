    ...
    return (<div className=' flex justify-center '>
        <div className='w-[95%] font-Quick'>
            ...
            <table className="min-w-full table-fixed  ">
                ...
                <tr className=''>
                    <th className="py-4 px-2 border-b">Event Name</th>
                    ...
                    <th className="py-2 px-4 border-b">No of Volunteers</th>
                ...
                {tableItems?.map((item) => (<tr className='hover:bg-[#DAF2F9] hover:text-[#2e3748] cursor-pointer' key={item.id}>
                    <td className="py-4 px-2 ">{item.eventName}</td>
                    ...
                    <td className="py-2 px-2 flex justify-center ">{item.numVolunteers}</td>
